...
| `stats_infer_proportion_lab.ipynb` | Inference for proportions | SaaS customer retention: new vs traditional onboarding at DataFlow | 95% CIs for proportions, two-sample z-test |
